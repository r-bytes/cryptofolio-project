...
const WatchList = () => {
    ...
    return (
        <div>
            {coins.length === 0
                ? (<p> You don't have any coins saved. Please save a coin to add it to your watch list. <Link className="text-accent hover:underline" to='/'>Click here</Link>  to search coins. </p>)
                : (
